""" Docstring for CCHQC.v1.qcapi.cchqc.config
  initiate configuration, initiate logger with loguru
"""
import os
...
def init_logger(loglevel):
    ...
    📝 logging to %localappdata% using loguru
      :param loglevel: log level of loguru
    """
